...
# then brave's 2000/month, then tavily and firecrawl, whose search allowance we
# already own), then the proven paid workhorse jina-search at ~$0.0005/query,
# then the vendors we have no key for yet, cheapest first (xmlriver ~$0.0003 on
# the Yandex index, parallel and octen at $1/1k, linkup and youcom at $5/1k),
# then serper, then exa at $7/1k.
#
